...
lista=[]
Cliente={}
lista = ["cafetera", "TV 50 pulgadas", "mouse gamer"]
Cliente = {"Nombre":"Mario Pedernera","DNI":56895632, "Domicilio":"Los alamos 4509", "Compras": lista, }
...
print(list(Compras.keys()))
print(list(Compras.values()))
